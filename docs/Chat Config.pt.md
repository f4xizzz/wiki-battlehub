...
!!! info "Compatibilidade de Mods de Chat"
    ...
    Se o seu servidor utiliza outro mod ou sistema de gerenciamento de chat (como *EssentialCmds*, *LPC*, etc.), não se preocupe! Você pode entrar em nosso [Discord Oficial](https://discord.gg/GbbbNvQG3N) e abrir um ticket de atendimento. Nós faremos a integração personalizada para o sistema de chat do seu servidor com o maior prazer.
