...
1. Em nosso [Discord](https://discord.gg/GbbbNvQG3N), disponibilizamos o download do pacote de *Structures* base do mod.  
...
1. Junte-se à nossa comunidade no [Discord](https://discord.gg/GbbbNvQG3N).  
